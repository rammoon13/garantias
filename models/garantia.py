...
class GarantiaProducto(models.Model):
 ...
 _order = 'number asc'
 number = fields.Integer(string='Número de Garantía', required=True, copy=False,
default=0)
 ...
 warranty_date = fields.Date(string='Fecha de Vencimiento',
compute='_compute_warranty_date', store=True)
